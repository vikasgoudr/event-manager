        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeLimitLower = table.Column<int>(type: "int", nullable: true),
                    AgeLimitUpper = table.Column<int>(type: "int", nullable: true),
                    HasAgeLimit = table.Column<bool>(type: "bit", nullable: false),
                    PosterImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    IsFreeToAttend = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentTiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentTiers_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    defaultOption = table.Column<int>(type: "int", nullable: true),
